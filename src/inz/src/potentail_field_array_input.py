...
def main(leader_name, followers):
	...
	sub_actual_position_follower = []
	sub_formation_controller_follower = []
	pub_field_follower = []
	
	
	for f in followers:	
		sub_actual_position_follower.append( rospy.Subscriber('position_' + f, Odometry, callback_actual_position_follower_1) )
		sub_formation_controller_follower.append( rospy.Subscriber('formation_control_' + f, Formation, callback_formation_control_follower_1) )
		pub_field_follower.append( rospy.Publisher('potentail_field_' + f, Twist, queue_size=10) )
