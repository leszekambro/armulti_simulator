...
if("TRUE" STREQUAL "TRUE")
  set(cvg_sim_gazebo_SOURCE_PREFIX /home/leszek/armulti_simulator_ws/src/tum_simulator/cvg_sim_gazebo)
  set(cvg_sim_gazebo_DEVEL_PREFIX /home/leszek/armulti_simulator_ws/devel)
  ...
  set(cvg_sim_gazebo_INSTALL_PREFIX /home/leszek/armulti_simulator_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cvg_sim_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leszek/armulti_simulator_ws/src/tum_simulator/cvg_sim_gazebo/${idir}'.  Ask the maintainer 'elliot <elliot@todo.todo>' to fix it.")
    endif()
